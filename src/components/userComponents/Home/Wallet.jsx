...
function Wallet(props) {
  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        const response = await axios.post("/get-appointments-completed", {
          userId,
        });
        ...
        const afterDeduction = updatedAppointments.reduce((accumulator, appointment) => {
                ...
                >
                  ...
                  <TableBody>
                    ...
                    >
                      ...
                      <TableCell align="right">Dr {row.doctorId.name}</TableCell>
                      <TableCell align="right">{row.doctorId.email}</TableCell>
                      <TableCell align="right">{row.amount_paid * 60 / 100}</TableCell>
